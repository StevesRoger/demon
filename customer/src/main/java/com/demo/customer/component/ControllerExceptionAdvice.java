package com.demo.customer.component;
...
public class ControllerExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleAnyException(Exception ex) {
        ...
        if (ex instanceof AuthenticationException)
            ...
            return ResponseEntity.status(e.getRawStatusCode()).contentType(e.getResponseHeaders().getContentType()).body(e.getResponseBodyAsString());
